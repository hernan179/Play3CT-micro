...
public class Mega {
	...
	public static void main(String args[]) throws Exception {
		...
		FileReader fileReader = new FileReader(
				new File(System.getProperty("user.dir") + "/src/main/java/com/example/play3ct/mega.txt"));
		...
		System.out.println("-----Pronostico mega para "+new SimpleDateFormat("MM/dd/yyy").format(new Date())+"----------");
